  ...
  render(){
    return(
      <Layout api={this.props.api}>
        <DataLoader
          get={() => loadCategory(this.props.api, this.props.collection.id)}
          renderLoader={() => <CollectionPageLoader collection={this.props.collection} api={this.props.api} {...this.props}/>}
          renderError={() => <CollectionPageError collection={this.props.collection} api={this.props.api} {...this.props}/>}
        >
          {collection => (
            <CollectionColorWrap collection={collection}>
              {(color, setColor, avatar, setAvatar) => 
            <Helmet>
