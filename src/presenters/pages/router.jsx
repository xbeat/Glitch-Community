...
const Router = ({api}) => (
  <React.Fragment>
    ...
    <Switch>
      ...
      <Route path="/login/facebook" exact render={({location}) => <FacebookLoginPage key={location.key} api={api} code={parse(location.search, 'code')} target={parse(location.search, 'target')}/>}/>
      <Route path="/login/github" exact render={({location}) => <GitHubLoginPage key={location.key} api={api} code={parse(location.search, 'code')} target={parse(location.search, 'target')}/>}/>
